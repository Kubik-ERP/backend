...
class TransferStockUpdatedDataDto {
  ...
  @ApiProperty({ example: '2025-11-06T15:55:48.752Z' })
  updatedAt: string;
}

export class UpdateTransferStockResponseDto {
  @ApiProperty({ example: 200 })
  statusCode: number;

  @ApiProperty({ example: 'Transfer stock updated successfully' })
  message: string;

  @ApiProperty({ type: TransferStockUpdatedDataDto })
  data: TransferStockUpdatedDataDto;
}