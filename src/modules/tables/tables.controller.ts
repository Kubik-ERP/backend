...
export class TablesController {
  ...
  @Post()
  async create(@Body() _createTableDto: CreateTableDto) {
    throw new NotFoundException(
      'This route is deprecated, use store-table instead',
    );
    // try {
  ...
  async update(
    @Param('id') _id: string,
    @Body() _updateTableDto: UpdateTableDto,
  ) {
    throw new NotFoundException(
      'This route is deprecated, use store-table instead',
    );
  ...
  async findByStoreId(
    ...
    @Param('floorNumber') _floorNumber: number,
  ) {
    throw new NotFoundException(
      'This route is deprecated, use store-table instead',
    );
